...
export DEVELOPMENT_CODE_SIGN_IDENTITY=Apple Development: Anton Filipov (U35FL47FA9)
export DISTRIBUTION_CODE_SIGN_IDENTITY=Apple Distribution: Anton Filipov (678KZ39P4T)
export DEVELOPMENT_TEAM=678KZ39P4T

export API_ID=1772727
export API_HASH=642e2e8606d59e394eaaf405013fc3bd

export BUNDLE_ID=pf.ph.telegra.Telegraph
...
export DEVELOPMENT_PROVISIONING_PROFILE_APP=telegram_false_bottom_development
export DISTRIBUTION_PROVISIONING_PROFILE_APP=telegram_false_bottom_adhoc
export ENTITLEMENTS_EXTENSION_SHARE=Share/Share-AppStoreLLC.entitlements
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_SHARE=telegram_false_bottom_share_development
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_SHARE=telegram_false_bottom_share_adhoc
export ENTITLEMENTS_EXTENSION_WIDGET=Widget/Widget-AppStoreLLC.entitlements
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_WIDGET=telegram_false_bottom_widget_development
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_WIDGET=telegram_false_bottom_widget_adhoc
export ENTITLEMENTS_EXTENSION_NOTIFICATIONSERVICE=NotificationService/NotificationService-AppStoreLLC.entitlements
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONSERVICE=telegram_false_bottom_notif_service_development
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONSERVICE=telegram_false_bottom_notif_service_adhoc
export ENTITLEMENTS_EXTENSION_NOTIFICATIONCONTENT=NotificationContent/NotificationContent-AppStoreLLC.entitlements
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONCONTENT=telegram_false_bottom_notif_content_development
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_NOTIFICATIONCONTENT=telegram_false_bottom_notif_content_adhoc
export ENTITLEMENTS_EXTENSION_INTENTS=SiriIntents/SiriIntents-AppStoreLLC.entitlements
export DEVELOPMENT_PROVISIONING_PROFILE_EXTENSION_INTENTS=telegram_false_bottom_siri_development
export DISTRIBUTION_PROVISIONING_PROFILE_EXTENSION_INTENTS=telegram_false_bottom_siri_adhoc
export DEVELOPMENT_PROVISIONING_PROFILE_WATCH_APP=telegram_false_bottom_watch_development
export DISTRIBUTION_PROVISIONING_PROFILE_WATCH_APP=telegram_false_bottom_watch_adhoc
export DEVELOPMENT_PROVISIONING_PROFILE_WATCH_EXTENSION=telegram_false_bottom_watch_extension_development
export DISTRIBUTION_PROVISIONING_PROFILE_WATCH_EXTENSION=telegram_false_bottom_watch_extension_adhoc
